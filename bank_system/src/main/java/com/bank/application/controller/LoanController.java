...
public class LoanController {
    ...
    public ResponseEntity<Loan> getLoan(@PathVariable Long id) {
        return ResponseEntity.ok(createLoanService.getLoan(id));
    }
    ...
    public ResponseEntity<Loan> approveLoan(@PathVariable Long id,
        ...
        return ResponseEntity.ok(approveLoanService.approveLoan(id, request.approvedAmount(),
    ...
    public ResponseEntity<Loan> rejectLoan(@PathVariable Long id) {
        return ResponseEntity.ok(approveLoanService.rejectLoan(id));
    }
    ...
    public ResponseEntity<Loan> disburseLoan(@PathVariable Long id) {
        return ResponseEntity.ok(approveLoanService.disburseLoan(id));
    }
